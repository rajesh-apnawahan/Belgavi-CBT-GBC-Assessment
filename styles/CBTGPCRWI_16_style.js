...
var style_CBTGPCRWI_16 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value >= 0.875000 && value <= 0.899800) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.899800 && value <= 0.924600) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 120.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.924600 && value <= 0.949400) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 120.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.949400 && value <= 0.974200) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 120.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.974200 && value <= 0.999000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 120.0 + size, points: 4,
